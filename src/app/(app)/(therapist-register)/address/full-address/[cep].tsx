...
const fullAddressSchema = z
  .object({
    street: z.string().trim().nonempty('Campo obrigatório'),
    hasNoHouseNumber: z.boolean(),
    number: z.string().trim(),
    complement: z.string().trim().nonempty('Campo obrigatório'),
    neighborhood: z.string().trim().nonempty('Campo obrigatório'),
    city: z.string().trim().nonempty('Campo obrigatório'),
    state: z.string().trim().nonempty('Campo obrigatório'),
  })
        ...
        <View className="mt-10 flex-1 space-y-10">
          ...
          <View className="w-full flex-row">
            <View>
              ...
              <Input
                ...
                autoCapitalize="none"
                className="mr-8 max-w-[144px] border-b-[1px] border-gray-500 px-2 pb-4 font-MontserratSemiBold text-sm text-gray-600 focus:border-brand"
              />
            </View>
          ...
          <View>
            {watchFields.complement && (
              <Text className="px-2 font-MontserratBold text-xs text-gray-600">Complemento</Text>
            )}
            <Input
              name="complement"
              control={control}
